	...
	<div id="wrapper">
	    ...
	    <div id="content-wrapper">
	    	<div id="container-fluid">
				<!-- Judul -->
				<h1 style="text-align: center;">Gigabyte - Terabyte</h1>
				...
				<form method="POST">
						<table width="366" align="center" border="1">
							...
							<tr>
								<td style="padding: 15px;text-align: center;"><?php echo (isset($_POST['satuan'])?$_POST['satuan']:''); ?> Gigabyte = <?php echo (isset($hitung)?$hitung:''); ?> Terabyte</td>
							</tr>
						</table>
				</form>
				<!-- form end -->
