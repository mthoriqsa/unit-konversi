	...
	<div id="wrapper">
	    ...
	    <div id="content-wrapper">
	    	<div id="container-fluid">
				...
				<br>
				<!-- form start -->
				<form method="POST" action="<?= 'jammenit'; ?>">
						<table width="366" align="center" border="1">
							...
							<tr>
								<td style="padding: 15px;text-align: center;"><?php echo (isset($_POST['satuan'])?$_POST['satuan']:''); ?> Jam = <?php echo (isset($hitung)?$hitung:''); ?> Menit</td>
							</tr>
						</table>
				</form>
				<!-- form end -->
