  ...
  <div id="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
              <h1 class="box-title">Agung Syaiful Umar (1634010013) - Bulan ke Hari</h1>

            <h2>Bulan ke Hari</h2>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= 'bulanhari'; ?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="bulan" class="col-sm-2 control-label">Bulan</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="bulan" placeholder="Bulan" name="bulan" value="<?= $bulan; ?>">
                  </div>
                </div>
                <div class="form-group">
